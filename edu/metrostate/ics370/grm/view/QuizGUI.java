...
public class QuizGUI extends JFrame {
	...
	private void refreshQuestion() {
		...
		Game[] dbTopGames = QuestionnaireInterface.getTopGames();
		for (int x = 0; x < 5; x++)
			topGameButtons[x].setText(dbTopGames[x].getName()); 
	}
...
//		    	QuestionnaireInterface.addWishlist(4);
	...
	private void setupTopGames() throws Exception {
		//if (QuestionnaireInterface.getTopGames()[0] == null)
		QuestionnaireInterface.init();
		//Game[] dbTopGames = QuestionnaireInterface.getTopGames();
		//if (dbTopGames[0] != null)
		//{
		//	for (int x = 0; x < 5; x++)
		//		System.out.println(dbTopGames[x].getName());
		//}
